...
# frontend-design（Cursor 入口）

**Canonical skill**：[`.skills/frontend-design/SKILL.md`](../../.skills/frontend-design/SKILL.md)

> 维护 skill 时 **只修改** `.skills/frontend-design/` 目录；本文件仅为 Cursor 发现入口，勿在此写长文。
